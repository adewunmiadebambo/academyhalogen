...
$qsThot = mysqli_query($connect, "select * from thought_leadership order by date desc");
$nsThot = mysqli_num_rows($qsThot);
...
<br><br>
Halogen Group is a premium, digital-enabled and integrated security group that provides end to end security risk solutions to enterprises as well as individual consumers.</strong>
<br><br>
<br><br>
</div>
<div class="col-md-1"></div>
...
<div class="container">
<div class="row">
<?php for($i=0; $i<$nsThot; $i++){
$rsThot = mysqli_fetch_array($qsThot);
?>
<div class="col-md-3" style="margin-bottom:30px;">
<div style="background:url('../acms/pages/<?php echo $rsThot['imagepath']; ?>') no-repeat; background-size:cover; height:200px;"></div>

<div class="details">

<div class="content">

<?php echo $rsThot['title'] ?> <br>

</div>

<div class="duration">
<?php echo date('F, Y', strtotime($rsThot['date'])); ?>
<div class="row">

<div class="col-6" style="padding-left:15px">&nbsp;</div>

<div class="col-6" style="padding-right:15px" align="right"><a href="../acms/pages/<?php echo $rsThot['filepath']; ?>" download=""><button class="btn1">Download now</button></a></div>
