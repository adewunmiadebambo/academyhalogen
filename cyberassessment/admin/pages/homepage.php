...
$qsHome = mysqli_query($connect, "select * from loan_application");
...
<td><?php echo $row['out_bal']; ?></td>
<td><?php echo $row['repay']; ?></td>
<td><?php echo $row['tenure']; ?></td>
<td><?php echo $row['date']; ?></td>
<!--<td><a href="view-loan-appli.php?id=<?php echo $row['id']; ?>"><i class="fa fa-eye-slash"></i></a></td>-->
</tr>
<?php } ?>
</tbody>
</table>
