                  ...
                  <?php } ?>
                    <form action="proc-password.php" method="post" enctype="multipart/form-data" >
						<div class="form-group input-group">
							...
							<input name="opass" type="password" class="form-control" placeholder="Enter Old Password" value="<?php echo $password; ?>">
						</div>
						<div class="form-group input-group">
							<span class="input-group-addon">New Password</span>
							<input name="password" type="password" class="form-control" placeholder="Enter New Password" value="<?php echo $password; ?>">
						</div>
						<div class="form-group input-group">
							<span class="input-group-addon">Confirm Password</span>
							<input name="confirm" type="password" class="form-control" placeholder="Confirm New Password" value="<?php echo $confirm; ?>">
						</div>
