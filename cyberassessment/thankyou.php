		...
		<div class="container assess">
			...
			<div class="col-md-10">
				...
				<div class="row">
					...
					<div class="col-md-6">
				<h2>Thank you for taking the online assessment. </h2>
				<br/>
				<h2>We will get back to you within the next 10 working days to advise you of the next stage in the selection process. </h2>
				</div>
