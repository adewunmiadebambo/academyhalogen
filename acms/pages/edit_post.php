...
?>
                                        <tr class="odd gradeX">
                                            ...
                                            <td><a href="edit_blog_post.php?id=<?php echo $row['id']; ?>"><?php echo $row['title']; ?> </a></td>
                                            <td><?php echo substr(strip_tags($row['content']),0,50); ?></td>
                                            <td><?php echo $row['author']; ?></td>
                                            <td><a href="edit_blog_post.php?id=<?php echo $row['id']; ?>">
                                            <input type="button" value="Edit Blog" /></a> 
                                            <a onClick="return confirm('Are you sure you want to delete this page');" href="del_btn.php?id=<?php echo base64_encode($row['id']); ?>&tab=<?php echo base64_encode('blog'); ?>&return_url=<?php echo base64_encode('edit_post.php'); ?>&filename=<?php echo base64_encode($row['filename']); ?>&folder=<?php echo base64_encode('blog'); ?>"><input type="button" value="Delete" />
                                            </a>
                                            </td>
                                        </tr>
<?php
