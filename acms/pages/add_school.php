...
<div class="row">
<div class="col-lg-12">
  <h1 class="page-header">Our Academy</h1>
</div>
<!-- /.col-lg-12 -->
</div>
<!-- /.row -->
...
<?php } ?>
<form action="create-school.php" method="post" enctype="multipart/form-data" >

<div class="form-group input-group">
<span class="input-group-addon">School</span>
<input name="title" type="text" class="form-control" placeholder="Enter school name" required="required">
</div>
<div class="form-group input-group">
<span><b>School Summary</b> <br></span>
<textarea name="summary" placeholder="Summary" id="summary"></textarea>
<script language="JavaScript" type="text/javascript">
generate_wysiwyg('summary');
</script>
</div>
<div class="form-group input-group">
<span><b>School Description</b> <br></span>
...
<div class="col-md-5"><?php include('pop-images.php'); ?>
</div>
</div>
