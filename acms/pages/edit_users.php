...
<script language="javascript" src="ckeditor/my-js.js"></script>
    ...
    <?php include('top-nav.php'); ?>
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                ...
                <h3>Edit <?php echo $row['username']; ?></h3>
                  ...
                  <?php if($correct)
            {
                ?>
                  ...
                  <?php } ?>
                    <form action="update_users.php" method="post" name="user" onSubmit="return adduser()" enctype="multipart/form-data" >
                                        <div class="form-group input-group">
                                            <span class="input-group-addon">Full Name</span>
                                            <input name="fullname" type="text" class="form-control" value="<?php echo $row['fullname']; ?>"  required="required">
                                        </div>
                                        <div class="form-group input-group">
                                            <span class="input-group-addon">Designation</span>
                                            <input name="designation" type="text" class="form-control" value="<?php echo $row['designation']; ?>" required="required">
                                        </div>
                                        <div id="usererror" class="has-error"><?php echo $section ?></div>
                                        <input name="username" type="hidden" class="form-control" value="<?php echo $row['username']; ?>" >
                                        <div id="passerror" class="has-error"></div>
                                        <div class="form-group input-group">
                                            <span class="input-group-addon">Password</span>
                                            <input name="password" type="password" class="form-control" value="<?php echo $row['password']; ?>" required="required">
                                        </div>
                                        <div class="form-group input-group">
                                            <span class="input-group-addon">Confirm Password</span>
                                            <input name="cpassword" type="password" class="form-control"  required="required">
                                        </div>
                                        <div id="priviledge" class="has-error"></div>
                                        <div class="form-group input-group">
                                            <label for="privilede"  class="input-group-addon">Priviledge</label>
