    ...
    <?php include('top-nav.php'); ?>
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">Client Area</h1>
                    </div>
                    <!-- /.col-lg-12 -->
                </div>
                <!-- /.row -->
                ...
                <?php } ?>
                    <form action="proc-client.php" method="post" enctype="multipart/form-data" >
...
?>
								<tr class="odd gradeX">
								<td><a href="edit_client.php?q=<?php echo base64_encode($row['id']); ?>"><b><?php echo $row['title']; ?></b></a></td>
								...
								<a href="edit_client.php?q=<?php echo base64_encode($row['id']); ?>">
								<input type="button" value="Edit"></a>

								
								<a onClick="return confirm('Are you sure you want to delete this page');" href="del_btn.php?id=<?php echo base64_encode($row['id']); ?>&tab=<?php echo base64_encode('client'); ?>&return_url=<?php echo base64_encode('add_client.php'); ?>"><input type="button" value="Delete" /></a>
