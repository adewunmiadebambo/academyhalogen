...
<?php } ?>
<form action="proc-newspage.php" method="post" enctype="multipart/form-data" >
...
<div class="form-group input-group">
<span class="input-group-addon">Media Type</span>
...
<select name="mp_title"  class="form-control">
...
<input name="date" type="date" class="form-control" placeholder="Banner Text">
</div>
<div class="form-group input-group">
...
<input name="banner_url" type="text" class="form-control" placeholder="Image Url e.g: example/image.jpg" required="required">
</div>
<div class="form-group input-group">
...
$query = "select * from news_page order by id desc";
...
?>
<tr class="odd gradeX">
<td><a href="edit_newspage.php?q=<?php echo base64_encode($row['id']); ?>"><b><?php echo $row['title']; ?></b></a></td>
...
<a href="edit_newspage.php?q=<?php echo base64_encode($row['id']); ?>">
<input type="button" value="Edit"></a>


<a onClick="return confirm('Are you sure you want to delete this page');" href="del_btn.php?id=<?php echo base64_encode($row['id']); ?>&tab=<?php echo base64_encode('news_page'); ?>&return_url=<?php echo base64_encode('add_news.php'); ?>"><input type="button" value="Delete" /></a>
