            ...
            <div class="container-fluid">
				...
				<form action="proc-banner.php" method="post" enctype="multipart/form-data" >
					...
					<div class="form-group input-group">
						...
						<input name="button_caption" type="text" class="form-control" placeholder="Button Caption">
					</div>
					<div class="form-group input-group">
						<span class="input-group-addon">Button URL</span>
						<input name="button_url" type="text" class="form-control" placeholder="Image Url e.g: example/image.jpg">
					</div>  
					<div class="form-group input-group">
