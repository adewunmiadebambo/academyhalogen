    ...
    <?php include('top-nav.php'); ?>
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                ...
                <?php } ?>
                    <form action="proc-homepage.php" method="post" enctype="multipart/form-data" >
						<div class="form-group input-group">
							<span class="input-group-addon">Title</span>
							<input name="page_title" type="text" class="form-control" placeholder="Title" required="required">
						</div>
						<div class="form-group input-group">
						...
						<div class="form-group input-group">
							...
							<input name="img_url" type="text" class="form-control" placeholder="Image Url e.g: example/image.jpg">
						</div>  
						<div class="form-group input-group">
							<span class="input-group-addon">External Link</span>
							<input name="ext_link" type="text" class="form-control" placeholder="http://www.example.com">
						</div>
						<div class="form-group input-group">
...
?>
								...
								<?php if($row['title'] == "Survey Monkey"){ ?>
								<td><a href="edit.php?q=<?php echo base64_encode($row['id']); ?>"><?php echo $row['content']; ?></a></td>
								<?php }else{ ?>
								<td><a href="edit.php?q=<?php echo base64_encode($row['id']); ?>"><?php echo substr($row['content'],0,80); ?></a></td>
								<?php } ?>
								<td><img src="<?php echo $row['image_url']; ?>" class="img-responsive" width="200"></td>
								<td><?php echo $row['ext_link']; ?></td>
								<td>
								
								<a href="edit.php?q=<?php echo base64_encode($row['id']); ?>">
								<input type="button" value="Edit"></a>

								
								<a onClick="return confirm('Are you sure you want to delete this page');" href="del_btn.php?id=<?php echo base64_encode($row['id']); ?>&tab=<?php echo base64_encode('home_page'); ?>&return_url=<?php echo base64_encode('add_homepage.php'); ?>"><input type="button" value="Delete" /></a>
