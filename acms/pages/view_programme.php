...
<td><a href="edit_programme.php?id=<?php echo $row['id']; ?>">
<input type="button" value="Edit Programme" /></a>
<a onClick="return confirm('Are you sure you want to delete this page');" href="del_btn.php?id=<?php echo base64_encode($row['id']); ?>&tab=<?php echo base64_encode('programmes'); ?>&return_url=<?php echo base64_encode('view_programme.php'); ?>&filename=<?php echo base64_encode($row['filename']); ?>&folder=<?php echo base64_encode('programmes'); ?>"><input type="button" value="Delete" />
</a>
</td>
</tr>
<?php
