    ...
    <?php include('top-nav.php'); ?>
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">Frequently Asked Question (FAQ)</h1>
                    </div>
                    <!-- /.col-lg-12 -->
                </div>
                <!-- /.row -->
                ...
                <?php } ?>
				<form action="create-faq.php" method="post" enctype="multipart/form-data" >
					
					<div class="form-group input-group">
						<span class="input-group-addon">FAQ Question</span>
						<input name="title" type="text" class="form-control" placeholder="Enter FAQ Question" required="required">
					</div>
					<div class="form-group input-group">
					<span><b>FAQ Answers</b> <br></span>
					...
					<div class="form-group input-group">
						...
						<input name="keyword" type="text" class="form-control" placeholder="Enter Keyword to enable search">
					</div>
