...
$query = "select * from events_page where id = '$q'";
    ...
    <?php include('top-nav.php'); ?>
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">Edit <?php echo $title; ?> News</h1>
                    </div>
                    <!-- /.col-lg-12 -->
                </div>
                <!-- /.row -->
                  ...
                  <?php if($correct)
            {
                ?>
                  ...
                  <?php } ?>
                    <form action="proc-edit-eventspage.php" method="post" enctype="multipart/form-data" >
						...
						<div class="form-group input-group">
							...
							<input name="banner_text" type="text" class="form-control" placeholder="Title" required="required" value="<?php echo $banner_text; ?>">
						</div>
					<div class="form-group input-group">
						<span class="input-group-addon">Date</span>
						<input name="date" type="text" class="form-control" value="<?php echo $date; ?>" required="required">
					</div>
															<div class="form-group input-group">
						<span class="input-group-addon">Time</span>
						<input name="time" type="text" class="form-control" value="<?php echo $time; ?>" placeholder="Event Time" required="required">
					</div>
						<div class="form-group input-group">
						...
						<div class="form-group input-group">
							...
							<input name="ext_link" type="url" class="form-control" placeholder="http://www.example.com" value="<?php echo $ext_link; ?>" >
						</div>
						<div class="form-group input-group">
                ...
                <div class="col-md-5">                
					<div class="form-group input-group">	
						...
						<img src="<?php echo $banner_url; ?>" class="img-responsive">
					</div> 
				</div>
