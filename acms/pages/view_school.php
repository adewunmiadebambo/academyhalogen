...
<td><a href="edit_school.php?id=<?php echo $row['id']; ?>"><?php echo $row['title']; ?></a></td>
<td><?php echo substr(strip_tags($row['content']),0,50); ?></td>
<td><?php echo $row['banner_url']; ?></td>

<td><a href="edit_school.php?id=<?php echo $row['id']; ?>">
<input type="button" value="Edit School" /></a>
<a onClick="return confirm('Are you sure you want to delete this page');" href="del_btn.php?id=<?php echo base64_encode($row['id']); ?>&tab=<?php echo base64_encode('school'); ?>&return_url=<?php echo base64_encode('view_school.php'); ?>&filename=<?php echo base64_encode($row['filename']); ?>&folder=<?php echo base64_encode('programmes'); ?>"><input type="button" value="Delete" />
</a>
</td>
</tr>
<?php
