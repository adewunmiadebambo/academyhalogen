                        ...
                        <div class="panel-heading">
                            <div class="row">
                                ...
                                <div class="col-xs-9 text-right">
                                    <div class="huge"><?php echo count_tab('downloads'); ?></div>
                                    <div>Brochure Downloads!</div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="panel panel-primary">
                        <div class="panel-heading">
                            <div class="row">
                                ...
                                <div class="col-xs-9 text-right">
                                    <div class="huge"><?php echo count_tab('prospect'); ?></div>
                                    <div>Prospective Candidate</div>
                                </div>
                            </div>
                        </div>
                        <a href="prospect">
                    ...
                    <div class="panel panel-green">
                        <div class="panel-heading">
                            <div class="row">
                                ...
                                <div class="col-xs-9 text-right">
                                    <div class="huge"><?php echo count_tab('eventreg'); ?></div>
