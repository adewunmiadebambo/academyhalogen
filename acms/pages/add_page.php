                ...
                ?>
                  ...
                  <?php } ?>
                    <form action="create-master-page.php" method="post" enctype="multipart/form-data" >
						...
						<div class="form-group input-group">
							<span class="input-group-addon">Upload Page Banner</span>
