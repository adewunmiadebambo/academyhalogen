...
<?php } ?>
<form action="proc-programs.php" method="post" enctype="multipart/form-data" >
...
?>
<tr class="odd gradeX">
<td><a href="edit_programs.php?q=<?php echo base64_encode($row['id']); ?>"><b><?php echo $row['title']; ?></b></a></td>
...
<a href="edit_programs.php?q=<?php echo base64_encode($row['id']); ?>">
<input type="button" value="Edit"></a>


<a onClick="return confirm('Are you sure you want to delete this page');" href="del_btn.php?id=<?php echo base64_encode($row['id']); ?>&tab=<?php echo base64_encode('programs'); ?>&return_url=<?php echo base64_encode('add_programs.php'); ?>"><input type="button" value="Delete" /></a>
