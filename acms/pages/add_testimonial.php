    ...
    <?php include('top-nav.php'); ?>
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                ...
                <?php } ?>
                    <form action="create-testimony.php" method="post" enctype="multipart/form-data" >
						<div class="form-group input-group">
							<span class="input-group-addon">Title</span>
							<input name="title" type="text" class="form-control" placeholder="Title" required="required">
						</div>
						<div class="form-group input-group">
							<span class="input-group-addon">Testimonial Link</span>
...
?>
								<tr class="odd gradeX">
								<td><a href="edit_testimony.php?q=<?php echo base64_encode($row['id']); ?>"><b><?php echo $row['title']; ?></b></a></td>
								<td><?php echo $row['link']; ?></td>
								<td><?php echo substr($row['content'],0,40); ?></td>
								<td><img src="uploads/<?php echo $row['image_url']; ?>" class="img-responsive" width="200"></td>
								<td><?php echo $row['ext_link']; ?></td>
								<td>
								
								<a href="edit_testimonial.php?q=<?php echo base64_encode($row['id']); ?>">
								<input type="button" value="Edit"></a>

								
								<a onClick="return confirm('Are you sure you want to delete this page');" href="del_btn.php?id=<?php echo base64_encode($row['id']); ?>&tab=<?php echo base64_encode('testimonial'); ?>&return_url=<?php echo base64_encode('add_testimonial.php'); ?>"><input type="button" value="Delete" /></a>
