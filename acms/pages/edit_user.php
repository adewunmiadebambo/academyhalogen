...
$query = "select * from login where username != 'administrator'";
...
?>
                                        <tr class="odd gradeX">
                                            ...
                                            <td><a href="edit_users.php?id=<?php echo $row['id']; ?>"><?php echo $row['fullname']; ?> </a></td>
                                            <td><?php echo $row['designation']; ?></td>
                                            <td><?php echo $row['username']; ?></td>
                                            <td><?php echo $row['password']; ?></td>
                                            <td><?php echo $row['priviledge']; ?></td>
                                            <td><a href="edit_users.php?id=<?php echo $row['id']; ?>">
                                            <input type="button" value="Edit User" /></a> 
                                            <a onClick="return confirm('Are you sure you want to delete this page');" href="del_btn.php?id=<?php echo base64_encode($row['id']); ?>&tab=<?php echo base64_encode('login'); ?>&return_url=<?php echo base64_encode('edit_user.php'); ?>&filename=<?php echo base64_encode($row['filename']); ?>&folder=<?php echo base64_encode('login'); ?>"><input type="button" value="Delete" />
                                            </a>
                                            </td>
                                        </tr>
<?php
