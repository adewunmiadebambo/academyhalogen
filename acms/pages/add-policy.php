    ...
    <?php include('top-nav.php'); ?>
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">Policy Page</h1>
                    </div>
                    <!-- /.col-lg-12 -->
                </div>
                <!-- /.row -->
                ...
                <?php } ?>
                <form action="proc-policy.php" method="post" enctype="multipart/form-data" >
					...
					<div class="form-group input-group">
						<span class="input-group-addon">Upload Policy</span>
...
$query = "select * from policy order by id desc";
...
?>
							...
							<td><a onClick="return confirm('Are you sure you want to delete this page');" href="del_btn.php?id=<?php echo base64_encode($row['id']); ?>&tab=<?php echo base64_encode('policy'); ?>&return_url=<?php echo base64_encode('add-policy.php'); ?>"><input type="button" value="Delete" /></a>
							</td>
						   </tr>
<?php
}
