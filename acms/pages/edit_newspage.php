...
$query = "select * from news_page where id = '$q'";
...
<?php } ?>
<form action="proc-edit-newspage.php" method="post" enctype="multipart/form-data" >
...
<?php if($category){ echo '<option selected value="'.$category.'">'.$category.'</option>';} ?>
...
<input name="banner_text" type="text" class="form-control" placeholder="Title" value="<?php echo $banner_text; ?>">
</div>
<div class="form-group input-group">
...
<input name="keyword" type="text" class="form-control" placeholder="Title" value="<?php echo $keyword; ?>">
</div>
<div class="form-group input-group">
