    ...
    <?php include('top-nav.php'); ?>
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">Master Page(s)</h1>
                    </div>
                    <!-- /.col-lg-12 -->
                </div>
                <!-- /.row -->
                ...
                <?php } ?>
                <form action="proc-masterpage.php" method="post" enctype="multipart/form-data" >
...
$query = "select * from master_page order by id desc";
...
?>
								<tr class="odd gradeX">
								<td><a href="edit_masterpage.php?q=<?php echo base64_encode($row['id']); ?>"><b><?php echo $row['title']; ?></b></a></td>
								<td><?php echo substr($row['banner_text'],0,50); ?></td>
								<td><?php echo substr($row['keyword'],0,50); ?></td>
								...
								<a href="edit_masterpage.php?q=<?php echo base64_encode($row['id']); ?>">
								<input type="button" value="Edit"></a>

								
								<a onClick="return confirm('Are you sure you want to delete this page');" href="del_btn.php?id=<?php echo base64_encode($row['id']); ?>&tab=<?php echo base64_encode('master_page'); ?>&return_url=<?php echo base64_encode('masterpage.php'); ?>"><input type="button" value="Delete" /></a>
