    ...
    <?php include('top-nav.php'); ?>
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">Events Page</h1>
                    </div>
                    <!-- /.col-lg-12 -->
                </div>
                <!-- /.row -->
                ...
                <?php } ?>
                <form action="proc-eventspage.php" method="post" enctype="multipart/form-data" >
					...
					<div class="form-group input-group">
						...
						<input name="banner_text" type="text" class="form-control" placeholder="Banner Text" required="required">
					</div>
					<div class="form-group input-group">
						<span class="input-group-addon">Date</span>
						<input name="date" type="date" class="form-control" placeholder="Banner Text" required="required">
					</div>
										<div class="form-group input-group">
						<span class="input-group-addon">Time</span>
						<input name="time" type="text" class="form-control" placeholder="Event Time" required="required">
					</div>
					<div class="form-group input-group">
...
$query = "select * from events_page order by id desc";
...
?>
							<tr class="odd gradeX">
							<td><?php echo $i + 1; ?></td>
							<td><a href="edit_eventspage.php?q=<?php echo base64_encode($row['id']); ?>"><b><?php echo $row['title']; ?></b></a></td>
							<td><?php echo $row['banner_text']; ?></td>
							<td><?php echo date('F, d, Y', strtotime($row['date'])); ?></td>
							<td><?php echo $row['time']; ?></td>
							<td><a href="edit_eventspage.php?q=<?php echo base64_encode($row['id']); ?>">
							<input type="button" value="Edit"></a><a onClick="return confirm('Are you sure you want to delete this page');" href="del_btn.php?id=<?php echo base64_encode($row['id']); ?>&tab=<?php echo base64_encode('events_page'); ?>&return_url=<?php echo base64_encode('add_events.php'); ?>"><input type="button" value="Delete" /></a>
							</td>
						   </tr>
<?php
}
