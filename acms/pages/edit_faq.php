...
$query = "select * from faq_page where id = '$id'";
    ...
    <?php include('top-nav.php'); ?>
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                ...
                <?php } ?>
                <form action="proc-edit-faq.php" method="post" enctype="multipart/form-data" >
					...
					<div class="form-group input-group">
						...
						<input name="keyword" type="text" class="form-control" placeholder="Enter Keyword to enable search" value="<?php echo $row['keyword']; ?>">
					</div>

					<div class="form-group input-group">
						<input type="hidden" name="id" value="<?php echo $id; ?>">
						<input type="submit" class="btn btn-primary" value="Edit FAQ">
					</div>
