...
<body>
    ...
    <?php include('top-nav.php'); ?>
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">Frequently Asked Question</h1>
                    </div>
                    <!-- /.col-lg-12 -->
                </div>
                <!-- /.row -->

                <h3>Edit / Remove FAQ</h3>
                   <br>
	...
	?>
									<tr class="odd gradeX">
										...
										<td><a href="edit_faq.php?id=<?php echo $row['id']; ?>"><?php echo $row['title']; ?></a></td>
										<td><?php echo substr(strip_tags($row['content']),0,50); ?></td>
										<td><?php echo $row['banner_url']; ?></td>
										<td><?php echo $row['keyword']; ?></td>
										
										
										<td><a href="edit_faq.php?id=<?php echo $row['id']; ?>">
										<input type="button" value="Edit FAQ" /></a> 
										<a onClick="return confirm('Are you sure you want to delete this page');" href="del_btn.php?id=<?php echo base64_encode($row['id']); ?>&tab=<?php echo base64_encode('faq_page'); ?>&return_url=<?php echo base64_encode('view_faq.php'); ?>&filename=<?php echo base64_encode($row['filename']); ?>&folder=<?php echo base64_encode('faq_page'); ?>"><input type="button" value="Delete" />
										</a>
										</td>
									</tr>
	<?php
