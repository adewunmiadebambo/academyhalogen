        ...
        <div id="page-wrapper">
                   ...
                   <?php if($correct)
            {
                ?>
                  ...
                  <?php } ?>
                    <form action="create-user.php" name="user" method="post" onsubmit="return adduser()" enctype="multipart/form-data" >
                                        ...
                                        <div class="form-group input-group">
                                            ...
                                            <input name="designation" type="text" class="form-control"  required="required">
                                        </div>
