...
$query = "select * from master_page where id = '$q'";
    ...
    <?php include('top-nav.php'); ?>
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">Edit Masterpage</h1>
                    </div>
                    <!-- /.col-lg-12 -->
                </div>
                <!-- /.row -->
                  ...
                  <?php if($correct)
            {
                ?>
                  ...
                  <?php } ?>
                    <form action="proc-edit-masterpage.php" method="post" enctype="multipart/form-data" >
						...
						<div class="form-group input-group">
							...
							<input name="keyword" type="text" class="form-control" placeholder="Title" required="required" value="<?php echo $keyword; ?>">
						</div>
						<div class="form-group input-group">
