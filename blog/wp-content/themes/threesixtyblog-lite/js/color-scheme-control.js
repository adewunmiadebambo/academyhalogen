/* global threesixtyblogLiteColorScheme, Color */
/**
...
( function( api ) {
	var cssTemplate = wp.template( 'threesixtyblog-color-scheme' ),
		colorSchemeKeys = [
			'accent_color',
			'link_color',
			'main_text_color'
		...
		ready: function() {
			if ( 'color_scheme' === this.id ) {
				this.setting.bind( 'change', function( value ) {
					var colors = threesixtyblogLiteColorScheme[value].colors;
	...
	function updateCSS() {
		var scheme = api( 'color_scheme' )(),
			css,
			colors = _.object( colorSchemeKeys, threesixtyblogLiteColorScheme[ scheme ].colors );
